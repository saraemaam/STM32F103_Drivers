...
void main (void ){
	...
	/*Enable GPIOA*/
	void RCC_voidEnableClock (RCC_APB2 , 2) ;
...
void LED2(void)
{
	...
	TOGGLE_BIT(Local_Pin1,0);
	MGPIO_VidSetPinValue( GPIOA , PIN1 , Local_Pin1 );
}

void LED3(void)
{
	static u8 Local_Pin2=0;
	TOGGLE_BIT(Local_Pin2,0);
	MGPIO_VidSetPinValue( GPIOA , PIN2 , Local_Pin2 );
}
